...
// MARK: - Hash
    ...
    //    {
    //        let result = [CC_MD2_DIGEST_LENGTH]
    //        CC_MD2(<#T##data: UnsafeRawPointer!##UnsafeRawPointer!#>, <#T##len: CC_LONG##CC_LONG#>, <#T##md: UnsafeMutablePointer<UInt8>!##UnsafeMutablePointer<UInt8>!#>)
...
//    private func hmacString(using alg:CCHmacAlgorithm, with key :String ) -> String
//    {
//        size_t size;
//        switch (alg) {
...
//    }
//
//    func hmacData(using alg:CCHmacAlgorithm, with key:Data) -> Data
//    {
//        size_t size;
//        switch (alg) {
//            case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
...
//    }
    ...
    //private
    //    private static const char base64EncodingTable[64]
    //    = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
    //    private static const short base64DecodingTable[256] = {
...
//    }
    ...
    /// - Parameter base64EncodedString: The encoded string.
//    func dataWithBase64EncodedString(_ base64EncodedString:String) -> Data
//    {
...
//MARK: - Inflate and deflate
    ///=============================================================================
    /// @name Inflate and deflate
    ///=============================================================================
    
    /// Decompress data from gzip data.
//    var gzipInflate: Data
//    {
...
//MARK: - Others
    ...
    /// - Parameter name: The file name (in main bundle).
